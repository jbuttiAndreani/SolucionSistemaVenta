        ...
        fetch("/Talle/Crear", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    swal("Listo!", "La Talle fue creada", "success")
                } else {
        ...
        fetch("/Talle/Editar", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "La Talle fue modificada", "success")
                } else {
                    swal("Los sentimos", responseJson.mensaje, "error")
                }
            })
...
$("#tbdata tbody").on("click", ".btn-eliminar", function () {
    ...
    swal({
        title: "¿Está seguro?",
        text: `Eliminar la Talle "${data.descripcion}"`,
        type: "warning",
                ...
                fetch(`/Talle/Eliminar?IdTalle=${data.idTalle}`, {
                    ...
                    .then(responseJson => {
                        ...
                        if (responseJson.estado) {
                            ...
                            swal("Listo!", "La Talle fue eliminada", "success")
                        } else {
                            swal("Los sentimos", responseJson.mensaje, "error")
                        }
                    })
